...
using PerfumeShop.Products.Commands;
using PerfumeShop.Products.Queries;
...
namespace PerfumeShop.Controllers.Admin
{
    ...
    public class ProductAdminController : Controller
    {
        ...
        public ProductAdminController(ApplicationDbContext db, IWebHostEnvironment env, PermissionService perm, IMediator mediator)
